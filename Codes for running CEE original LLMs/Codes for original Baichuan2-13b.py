...
model = AutoModelForCausalLM.from_pretrained("/root/autodl-tmp/Baichuan2-13B-Chat",revision="v2.0", device_map="auto", torch_dtype=torch.bfloat16, trust_remote_code=True)
...
years=["1Z101010","1Z101020","1Z101030","1Z101040","1Z101050","1Z101060","1Z101070","1Z102010","1Z102020","1Z102030","1Z102040","1Z102050","1Z102060","1Z102070","1Z102080","1Z103010","1Z103020","1Z103030","1Z103040","1Z103050","1Z103060","1Z103070","1Z103080"]
for year in years:
  ...
  for i in range(len(Questions)):
    ...
    {"Question":Questions[i],"Correct_Answer":Answers[i],"Answer1":answer1,"Score1":final_score(Questions[i],answer1,Answers[i])}])
      ...
      print("No Question",i+1,"\n","Right_Answer:",Answers[i],"\nAnswer_from_original_baichuan2-13b:",answer1.strip().replace("\n",""))

      df = pd.concat([df, df2], axis=0)

  save_df_to_excel(df, "Answers_from_Original_baichuan2_13B_EE_"+year+".xlsx", "sheet1")
